    ...
    <div>
        ...
        <div className="blogs grid grid-cols-3 gap-10 min-h-[550px] py-5">
            ...
            <div className="form col-span-2">
                <p className="text-xl mb-10">Contact me </p>
                <div className="form">
                    <div className="input-fields grid grid-cols-2 gap-6 py-3">
                        <input type="text" placeholder="johnson" className="py-2 px-2 rounded-md focus:outline-none"/>
                        <input type="text" placeholder="Khaled" className="py-2 px-2 rounded-md focus:outline-none"/>
                    </div>
                    <div className="input-fields grid grid-cols-2 gap-6 py-3">
                        <input type="email" placeholder="example@gmail.com" className="py-2 px-2 rounded-md focus:outline-none"/>
                        <input type="text" placeholder="+250 780 922 562" className="py-2 px-2 rounded-md focus:outline-none"/>
                    </div>
                </div>
                <div className="relative">
                    <textarea name="" id="" cols={90} rows={10} className="absolute right-0 left-0 focus:outline-none px-2" placeholder="Type in message ......."/>
                </div>
            </div>
        </div>
    </div>
