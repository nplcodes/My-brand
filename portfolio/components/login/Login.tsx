...
const Login = () => {
  return (
    // login min-h-[550px] px-16
    <div className="login min-h-[550px] px-5">
        ...
        {/* grid grid-cols-2 px-32 min-h-[500px] py-5 shadow-[0_3px_10px_rgb(0,0,0,0.2)] */}
        <div className="min-h-[500px] py-5 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
          {/* centered items-center justify-center */}
          <div className="centered items-center justify-center hidden">
          ...
          <div className="field-input px-10 flex flex-col gap-4 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]"> 
                <div className="each-field py-10">
                  {/* text-2xl font-bold flex justify-center */}
